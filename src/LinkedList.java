...
public class LinkedList<T> implements Methods<T> {
    ...
    private class LinkedListIterator implements Iterator<T> {
         ...
         * 
         * @return true if index is smaller then list size,
         */
         ...
         * NoSuchElementException, meaning that the we have iterated through the entire
         * list
         * 
